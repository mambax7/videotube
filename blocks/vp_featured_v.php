...
function videotube_featured_v($options) {
...
function featured_edit_v($options)
{
    global $xoopsConfig, $xoopsDB;
    
	$form  = "<table border='0'>";
	$form .= "<tr><td>"._BL_VP_FTV_VIDEO1."</td><td><select name='options[]'>";
	if ($options[0] == 0) {
    ...
    $form .= "</select>";
	$form .= "</td></tr>";
		$form .= "<tr><td>"._BL_VP_FTV_VIDEO2."</td><td><select name='options[]'>";
	if ($options[1] == 0) {
	  $form .= "<option value=0 selected='selected'>Not selected</option>";
	}else{
	  $form .= "<option value=0>Not selected</option>";
	...
	$form .= "<tr><td>"._BL_VP_FTV_VIDEO3."</td><td><select name='options[]'>";
	if ($options[2] == 0) {
	  $form .= "<option value=0 selected='selected'>Not selected</option>";
	}else{
	  $form .= "<option value=0>Not selected</option>";
	...
	$form .= "<tr><td>"._BL_VP_FTV_VIDEO4."</td><td><select name='options[]'>";
	if ($options[3] == 0) {
	  $form .= "<option value=0 selected='selected'>Not selected</option>";
	}else{
	  $form .= "<option value=0>Not selected</option>";
	...
	$form .= "<tr><td>"._BL_VP_FTV_VIDEO5."</td><td><select name='options[]'>";
	if ($options[4] == 0) {
	  $form .= "<option value=0 selected='selected'>Not selected</option>";
	}else{
	  $form .= "<option value=0>Not selected</option>";
