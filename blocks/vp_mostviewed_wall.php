...
//  Date:       01/06/2009                                                   //
//  Module:     Video Tube                                                   //
//  File:       blocks/vp_mostviewed_wall.php                                //
//  Version:    1.81                                                         //
//  ------------------------------------------------------------------------ //
//  Change Log                                                               //
//  ***                                                                      //
...
function videotube_mostviewed_wall($options) {
		...
		$result = $xoopsDB->queryF("SELECT id, uid, date, code, title, artist, views, service, thumb FROM ".$xoopsDB->prefix()."_vp_videos WHERE pub='1' ORDER BY views DESC limit 0, $numVideos");
...
function mostviewed_edit_wall($options)
{
	$form  = "<table border='0'>";
	$form .= "<tr><td>"._BL_VP_MV_VIDEOWALL."</td><td>";
