...
function playVid(vidCode,vidId,title,thumb,voheight,vowidth) {
  if (vidPaneID.style.display=='block') {
    ...
    var vidstring ='<center><object width="'+vowidth+'" height="'+voheight+'"><param name="movie" value="'+vidId+'"></param><param name="allowFullScreen" value="true"></param><param name="allowScriptAccess" value="always"></param>';
    vidstring+='<embed src="'+vidId+'&autoplay=1" allowScriptAccess="always"';
    vidstring+=' type="application/x-shockwave-flash"';
    vidstring+=' height="'+voheight+'" width="'+vowidth+'"></object></center>';
